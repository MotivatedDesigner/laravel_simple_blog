...
<div class="sidebar-items style-two">
  ...
  <aside class="widget bt-about-me-widget">
    ...
    <div class="widget-content">
      <div class="author-thumb">
        <a href="#"><img src="{{asset('images/widget/about/about-me2.jpg')}}" alt="img" /></a>
      </div>
      <div class="info">
        ...
        <div class="author-sign">
          <img src="{{asset('images/widget/about/signature.png')}}" alt="img" />
        </div>
      </div>
    </div>
  </aside>
  ...
  <aside class="widget widget-post-list">
    ...
    <div class="widget-content">
      <article class="post">
        <div class="thumb-wrap">
          <a href="single-post.html">
            <img  src="{{asset('images/widget/post/wp_1.jpg')}}" alt="post" />
          </a>
        </div>
        <!--./ thumb-wrap -->
      ...
      <article class="post">
        <div class="thumb-wrap">
          <a href="single-post.html">
            <img src="{{asset('images/widget/post/wp_2.jpg')}}" alt="post" />
          </a>
        </div>
        <!--./ thumb-wrap -->
        <div class="content-entry-wrap">
      ...
      <article class="post">
        <div class="thumb-wrap">
          <a href="single-post.html">
            <img src="{{asset('images/widget/post/wp_3.jpg')}}" alt="post" />
          </a>
        </div>
        <!--./ thumb-wrap -->
        <div class="content-entry-wrap">
      ...
      <article class="post">
        <div class="thumb-wrap">
          <a href="single-post.html">
            <img src="{{asset('images/widget/post/wp_4.jpg')}}" alt="post" />
          </a>
        </div>
        <!--./ thumb-wrap -->
        <div class="content-entry-wrap">
  ...
  <aside class="widget widget_advertisement">
    <div class="widget-content">
      <a href="#"><img src="{{asset('images/widget/ads.jpg')}}"  alt="Advertisement" /></a>
    </div>
    <!-- /.widget-content -->
  </aside>
